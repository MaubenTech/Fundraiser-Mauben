...
// import type { PaymentRequest as DonationPaymentRequest, DonationRecord } from "@/lib/types/donation";

// export async function POST(request: NextRequest) {
// 	try {
// 		const body: DonationPaymentRequest = await request.json();
...
// 		// 	donor_name: body.donor.name,
// 		// 	donor_email: body.donor.email,
// 		// 	donor_anonymous: body.donor.anonymous,
...
// async function processCardPayment(paymentData: DonationPaymentRequest) {
...
// async function processBankTransfer(paymentData: DonationPaymentRequest) {
...
// async function processMobilePayment(paymentData: DonationPaymentRequest) {
...
// async function sendConfirmationEmail(donation: DonationRecord) {
